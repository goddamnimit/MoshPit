...
#ifndef MOSHPIT_SWIFT_H
#define MOSHPIT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MoshPit",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC7MoshPit12CameraSource")
...
@class NSBundle;
@class NSCoder;
SWIFT_CLASS("_TtC7MoshPit12KeyCommandVC")
@interface KeyCommandVC : UIViewController
...
SWIFT_CLASS("_TtC7MoshPit12MoshRecorder")
@interface MoshRecorder : NSObject <AVCaptureAudioDataOutputSampleBufferDelegate>
- (void)captureOutput:(AVCaptureOutput * _Nonnull)output didOutputSampleBuffer:(CMSampleBufferRef _Nonnull)sampleBuffer fromConnection:(AVCaptureConnection * _Nonnull)connection;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
SWIFT_CLASS("_TtC7MoshPit12MoshRenderer")
@interface MoshRenderer : NSObject <MTKViewDelegate>
